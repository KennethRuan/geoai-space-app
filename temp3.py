...
def app():
    ...
    def clicked(button, center, zoom):
        print("CLICKED")
    ...
    try:
        st.session_state['center'] = tuple(map(float, coordinates.split(",")))
    except ValueError:
        pass
    ...
    sw, ne = output['bounds']['_southWest'], output['bounds']['_northEast']
    ...
    st.button("Process Data", on_click=clicked, args=[True, center, zoom])
